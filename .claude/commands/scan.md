...
Report back: how many slots are open this week, how many raw postings were fetched, how many died at Gate 0 and why, and which candidates were promoted to `data/queue.json`.
