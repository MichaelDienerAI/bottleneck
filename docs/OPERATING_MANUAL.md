...
| `npm test` | Fourteen suites, 437 assertions, no network, no model. Run before you trust anything |
...
**"Is anything broken?"**
```bash
npm test                            # expect 97 + 43 + 19 + 32 + 19 + 31 + 32 + 31 + 27 + 13 + 16 + 59 + 8 + 10 passing, 437 total
```
